  ...
  <div class="page">
    <div id="service">
      ...
      <section>
        ...
        <p data-scroll>
          CARVANCLは、誰が行なったとしてもあまり違いが生まれない、オペレーティブなデザインの仕事を扱う会社ではありません。
        </p>
      ...
      <section class="make-brand">
        ...
        <p data-scroll>
          まだ正解が確立していない中で、その企業・プロダクトを熱狂的に愛してくれるファンをつくりだし、クライアント様と共にブランドを積み上げていく会社です。
        </p>
      ...
      <section class="design-team">
        ...
        <p data-scroll>
          御社のデザイン責任者の立場をディレクターが担い、プロジェクト全体をリードします。
        </p>
        <p data-scroll>
          クライアント様と綿密なヒアリングやディスカッション、アイデアブレストを重ね、デザインアウトプットを洗練させていきます。
        </p>
      ...
      <section class="dmf">
        ...
        <p data-scroll>
          デザインとはコミュニケーションであり、コミュニケーションの最も大きなリスクは「伝わらないこと」よりも「誤解」です。
        </p>
        <p data-scroll>
          そのため、理想的なコミュニケーションが生まれる前にデザインアウトプットを拡散することはリスクを伴います。
        </p>
        <p data-scroll>
          弊社はデザインプロトタイプを用いて対象ユーザーへのインタビューを行い「伝えたいことが伝わる・解決したいことが解決されている」状態の実現を目指します。
        </p>
      </section>
      ...
      <section class="process-container">
        ...
        <div>
          <h2 class="subheading">
            ...
            <span class="en">Analysis</span><span class="ja">分析と最適化</span>
          </h2>
          <p>
        ...
        <div>
          ...
          <p>
            様々なデザインの方向性と解決策を検討し、対象ユーザーを巻き込んだ理想的なシナリオを探るプロセスです。
          </p>
          <p>
            収集したデータ・情報からインサイトを引き出し、様々な仮説を具体的に検証していきます。その過程で、ペルソナやストーリーボードを洗練させていき、特定した問題と解決策との対応を図ります。
          </p>
        </div>
      </section>
      ...
      <section class="branding-with-us">
        ...
        <p>
          1つのデザインプロジェクトによって、ブランドが形作られることはあり得ません。
        </p>
        <p>
          理想的なコミュニケーションがあらゆる方面で達成されていることで、企業・プロダクトはブランド化していきます。
        </p>
        <p>
          CARVANCLはWebアプリケーション・Webサイトを中心に、様々なデザインアウトプットを製作可能な体制をとっています
        </p>
        <p>
          御社にとって頼りになるデザインの伴走者として、末長く複数のプロジェクトを共にしていきたいと考えます。
        </p>
      </section>
